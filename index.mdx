---
title: "Introduction"
description: "This is the documentation for the Relworx payments API version 2. API version 2 is currently the default api version."
---

## Setting up

Welcome to Relworx Payments API. This API enables you to integrate online payments into your internet business. Our developer friendly API gives you access to mobile money in Uganda (MTN/Airtel), Kenya (Safaricom MPESA), and Tanzania (Airtel/Tigo/Halopesa), where you can request or send payments to valid mobile money subscribers.
